...
Place your `.webp` project thumbnail images here.

## Required files (match the filenames in `src/data/projects.js`):

- `pos-system.webp` — POS System screenshot
...
- Format: `.webp` (convert PNG/JPG to WebP using squoosh.app)
- Thumbnail size: 1200×675px
